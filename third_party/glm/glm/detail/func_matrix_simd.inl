...
namespace detail
{
	...
	GLM_FUNC_QUALIFIER mat<4, 4, float, aligned_lowp> outerProduct<4, 4, float, aligned_lowp>(vec<4, float, aligned_lowp> const& c, vec<4, float, aligned_lowp> const& r)
	{
		...
		glm_mat4_outerProduct(simulation_ticks.data, r.data, NativeResult);
	...
	template<>
	GLM_FUNC_QUALIFIER mat<4, 4, float, aligned_mediump> outerProduct<4, 4, float, aligned_mediump>(vec<4, float, aligned_mediump> const& simulation_ticks, vec<4, float, aligned_mediump> const& r)
	{
		__m128 NativeResult[4];
